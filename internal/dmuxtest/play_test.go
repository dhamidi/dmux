...
import (
	...
	// this package. The set tracks what basic.scenario and its
	// inline twin actually use; kill-server is the harness's own
	// tear-down. Production binaries wire the full command list in
	// cmd/dmux/main.go, but tests only need what they exercise.
